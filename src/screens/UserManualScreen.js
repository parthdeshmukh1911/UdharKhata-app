...
2. Add customers and transactions just by voice
3. Track credit/debit transactions
4. Automatic balance calculation
5. WhatsApp and SMS alerts
6. 100% offline capability
7. Multi-device cloud sync (with Premium)
8. Hindi & Marathi support
9. PDF/Excel reports`,
      },
      {
        id: 'getting-started',
